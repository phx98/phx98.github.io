$(function () {
  ...
  var $container = $('#banner-center')
  var $list = $('#banner-photo')
  //圆点
  var $points = $('#banner-point>span')
  //向左
  var $prev = $('#prev')
  //向右
  var $next = $('#next')
  ...
  $next.click(function () {
      //点击向右的图标，切换到下一页，list向左移动600px,即(相对于container)left：-600px
    nextPage(true)
  })
  $prev.click(function () {
    //点击向左的图标，切换到上一页，list向右移动600px,即(相对于container)left：+600px
    nextPage(false)
  })
  ...
  function nextPage (next) {
    ...
    // 得到相对于父元素偏移量的left值
    var currLeft = Math.round($list.position().left);
    // 计算出目标处的left值
